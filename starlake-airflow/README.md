...
* **Creating** the **Dataproc cluster** via `airflow.providers.google.cloud.operators.dataproc.DataprocCreateClusterOperator`
* **Submitting Dataproc jobs** via `airflow.providers.google.cloud.operators.dataproc.DataprocSubmitJobOperator`
* **Deleting** the **Dataproc cluster** via `airflow.providers.google.cloud.operators.dataproc.DataprocDeleteClusterOperator`
